...
func _register_all() -> void:
	...
	_add("Wither",    "attack",  "Attack for 100% SHARP. Has a 60% chance to lower the target's SHARP by 2.",                  "Vritra sharpens its tongue upon the enemy, addling the mind and bringing strength to rot.",
		false, false, false, false, "PartAnchors/Mouth", "Coil", 2)
	_add("Coil",      "attack",  "Attack for 80% SHARP. Restores a small amount of CORP on hit.",                              "Starved and hollow, the serpent wrings what it can from the moment.",
		false, true,  false, true,  "PartAnchors/Mouth")
