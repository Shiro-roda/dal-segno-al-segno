...
const CHANNEL_TEXT_TABLE : Array = [
	# ── RED — stark, physical, warning ──────────────────────────────────────
	{"text": "STOP",              "channel": "red", "condition": ""},
	{"text": "DO NOT",            "channel": "red", "condition": ""},
	{"text": "YOU WERE WARNED",   "channel": "red", "condition": "has_segno"},
	{"text": "IT REMEMBERS",      "channel": "red", "condition": "has_segno"},
	{"text": "TURN BACK",         "channel": "red", "condition": ""},
	{"text": "AGAIN",             "channel": "red", "condition": "caesura"},
	{"text": "NOT YET",           "channel": "red", "condition": "low_hp"},
	{"text": "THEY KNOW",         "channel": "red", "condition": "al_segno"},
	{"text": "HOLD",              "channel": "red", "condition": ""},
	{"text": "COUNTED",           "channel": "red", "condition": "high_transit"},
	# ── GREEN — organic, alive, creeping ───────────────────────────────────
	{"text": "still here",         "channel": "green", "condition": ""},
	{"text": "growing",            "channel": "green", "condition": ""},
	{"text": "it waited",          "channel": "green", "condition": "has_segno"},
	{"text": "between the walls",  "channel": "green", "condition": ""},
	{"text": "they left this",     "channel": "green", "condition": "cleared_room"},
	{"text": "not alone",          "channel": "green", "condition": "party_size_2"},
	{"text": "remember the way",   "channel": "green", "condition": "has_segno"},
	{"text": "softer now",         "channel": "green", "condition": "low_hp"},
	{"text": "the second time",    "channel": "green", "condition": "caesura"},
	{"text": "patient",            "channel": "green", "condition": ""},
	# ── BLUE — cold, distant, spectral ─────────────────────────────────────
	{"text": "echo",               "channel": "blue", "condition": ""},
	{"text": "long ago",           "channel": "blue", "condition": ""},
	{"text": "the first time",     "channel": "blue", "condition": "has_segno"},
	{"text": "before you",         "channel": "blue", "condition": ""},
	{"text": "carried forward",    "channel": "blue", "condition": "high_transit"},
	{"text": "Kendall",            "channel": "blue", "condition": ""},
	{"text": "unfinished",         "channel": "blue", "condition": "caesura"},
	{"text": "the distance remains","channel": "blue", "condition": "al_segno"},
	{"text": "still counting",     "channel": "blue", "condition": "has_segno"},
	{"text": "further",            "channel": "blue", "condition": ""},
]
...
func _rebuild_segno_overlay() -> void:
	...
	if dungeon == null:
		return
	if dungeon.segno_pos == Vector2i(-999, -999) and dungeon.past_segno_positions.is_empty():
		return
...
func _spawn_text_mesh(txt: String, col: Color,
	...
	var font   := load("res://assets/Fonts/SpaceMono-Bold.ttf") as Font
	var shader := load("res://flicker_text.gdshader") as Shader
...
func _spawn_red_channel_text() -> void:
	...
	for txt in texts:
		var pos := Vector3(
			...
			randf_range(-2.0, 4.0),
			randf_range(-18.0, -1.0))
		_spawn_text_mesh((txt as String).to_upper(),
			Color(1.0, 0.12, 0.08),
			randf_range(6.0, 14.0), 0.55,
			pos, _chan_text_r)
...
func _build_radial_ring(origin: Vector2, choices: Array):
	...
	# ── Road tile button (downward arc, only when tiles remain) ──
	_road_btn_wrap = null
	...
	if road_count > 0:
		...
		var road_btn := _make_ring_button("")
