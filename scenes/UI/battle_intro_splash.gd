...
const SPEAKER_FONTS : Dictionary = {
	"Kendall": "res://assets/Fonts/SpaceMono-Bold.ttf",
	"Hue": "res://assets/Fonts/Lora/Lora-VariableFont_wght.ttf",
	"Indra":   "res://assets/Fonts/Josefin_Slab/JosefinSlab-VariableFont_wght.ttf",
	"Vritra":  "res://assets/Fonts/Cormorant_Garamond/CormorantGaramond-Italic-VariableFont_wght.ttf",
}
const DEFAULT_FONT := "res://assets/Fonts/SpaceMono-Italic.ttf"
...
func _build_ui() -> void:
	...
	_mat.shader = load("res://scripts/Shaders/chatter_crt.gdshader")
