...
func _register_all() -> void:
	...
	_add("Galvanize", "support", "Restores Anima Portions to both companions and raises all allies' attack. Also grants you an additional Beat Bolt.", "Indra fills his comrades with the electric pride of leading the charge, restoring their will to fight and invigorating their attacks.", true)
